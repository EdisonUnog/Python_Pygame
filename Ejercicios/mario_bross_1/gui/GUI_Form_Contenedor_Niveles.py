...
from niveles.Class_Colores import Colores
...
class FormContenedorNivel(Form):
    def __init__(self, pantalla: pygame.Surface, nivel) -> None:
        super().__init__(pantalla, 0, 0, pantalla.get_width(), pantalla.get_height(), Colores.NEGRO, "Red", 4, True)
        ...
        self._btn_home = Button_Image(screen=self._slave, 
                                    ...
                                    onclick_param="", path_image="gui/home.png") ## menu dentro del juego
