...
plataforma_uno = pygame.image.load("niveles/plataforma.png")
piso =  pygame.image.load("niveles/3.png")

plataforma_dos = pygame.image.load("niveles/plataforma.png")
piso_dos =  pygame.image.load("niveles/3.png")
