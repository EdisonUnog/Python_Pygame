...
class Button_Image(Widget):
    def __init__(self, screen,master_x,master_y, x,y,w,h, path_image, onclick=None, onclick_param=None, text="", font="Arial", 
                    font_size=12, font_color= NEGRO, color_background = None, color_border = NEGRO, border_size = -1):
