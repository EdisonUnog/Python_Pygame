...
class LevelUno(Form):
    def __init__(self, screen, x, y, w, h, color_background, color_border, border_size=-1, active=True) -> None:
        ...
        self.lista_info = DataLevels(self._slave, "nivel_uno")
        ...
        #lista Widget del form lvl 1
        self._btn_home = Button_Image(screen=self._master, x=ANCHO / 2 -60, y=ALTO - 45, master_x=0, master_y=0, w=120, h=40, onclick=self.btn_home_click, 
    ...
    def update(self,lista_eventos):
        ...
        if(not self.lista_info.win and not self.lista_info.player.muerte and self.time_juego > 0):
            ...
            #self.padre.update(lista_eventos)
