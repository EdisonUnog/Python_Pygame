...
class LevelUno(Form):
    def __init__(self, name, master_form, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        self.lista_info = Datalevels(master_form,"nivel_uno")
        ...
        self.barra_vida = BarraVida(self,x=10,y=10,w=500,h=50,color_background=NEGRO,color_border=AZUL,
                                    image_background=None,
                                    image_progress=None,
                                    value = self.lista_info.player.hp, 
                                    value_max=self.lista_info.player.hp,
                                    color_vida=BLANCO)
        ...
        #self.win = Widget(self,ANCHO / 2 - 450/2,170,500,300,None,None,"Recursos/Menu/Buttons/you win.png",None,"Arial",30,NEGRO)
        self.win = Widget(self,x,y,w,h,None,None,"Recursos/Menu/Buttons/you win.png",None,"Arial",30,NEGRO)

        #self.lose = Widget(self,ANCHO / 2 - 450/2,170,500,300,None,None,"Recursos/Menu/Buttons/you lose.png",None,"Arial",30,NEGRO)
    ...
    def update(self,delta_ms,lista_events):
        ...
        if(not self.lista_info.win and not self.lista_info.player.muerte and self.time_juego > 0):
            ...
            #self.lista_info.player.draw(self.master_form)
            ...
            self.forms_dict["niveles"].condicion_lvl2 = True
    ...
    def display_finish_lvl(self,delta_ms):
        ...
        if(self.acumulador_time >= 2000):
            ...
            self.forms_dict["nivel_dos"].lista_info.player.puntos_player = self.puntos_totales
