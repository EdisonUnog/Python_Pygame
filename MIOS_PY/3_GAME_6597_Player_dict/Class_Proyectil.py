...
lista_proyectiles = [pygame.image.load("Recursos/balas/1.png"),
                    pygame.image.load("Recursos/balas/2.png"),
                    pygame.image.load("Recursos/balas/3.png"),
                    pygame.image.load("Recursos/balas/4.png"),
                    pygame.image.load("Recursos/balas/5.png"),
                    pygame.image.load("Recursos/balas/6.png"),
                    pygame.image.load("Recursos/balas/7.png")]