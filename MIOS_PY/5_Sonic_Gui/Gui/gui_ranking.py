...
class FormRanking(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_border, active, image_background=None, color_background=None) -> None:
        ...
        for i in range(4):
            self.lista_widget_nombre.append(Widget(master_form=self,x=60,y=self.eje_y,w=160,h=65,color_background=None,color_border=None,
                                        image_background="Recursos/Menu/Table.png",text= self.data_player[i][1],font="Arial",font_size=40,font_color=BLANCO))
            
            self.lista_widget_puntos.append(Widget(master_form=self, x=240, y=self.eje_y, w=100, h=65, color_background=None, color_border=None,
                                        image_background="Recursos/Menu/Table.png", text=self.data_player[i][2], font="Arial", font_size=40, font_color=BLANCO))
            
            self.eje_y += 70

        self.score = Widget(master_form=self, x=150, y=-30, w=100, h=150, color_background=None, color_border=None, image_background=None, text="Score",
        ...
        self.boton_atras = Button(master=self,x=15,y=510,w=70,h=50,color_background=None,color_border=None,image_background="Recursos/Menu/Buttons/home.png",
                                    on_click=self.on_click_boton1,on_click_param="ranking",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
