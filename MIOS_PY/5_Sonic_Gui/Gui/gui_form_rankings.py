...
class FormClasificaciones(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        self.text_ranking = Widget(self,ANCHO_VENTANA/2 - 400/ 2,100,400,100,None,None,None,"RANKING","Arial",40,BLANCO,)

        self.ranking_final = Button(master=self,x=ANCHO_VENTANA/2 - 200/ 2,y=350,w=200,h=80,color_background=None,color_border=None,
