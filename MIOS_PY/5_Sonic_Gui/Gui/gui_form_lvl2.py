...
class LevelDos(Form):
    def __init__(self, name, master_form, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        #Puntos
        self.score = Widget(self,1300,0,200,50,None,None,"Recursos/Menu/Buttons/fondo_botones.png",self.lista_info.player.puntos_player,"Arial",30,C_BLACK)
        ...
        self.time = Widget(self,650,0,200,50,None,None,"Recursos/Menu/Buttons/fondo_botones.png",self.time_juego,"Arial",30,C_BLACK)
        ...
        self.win = Widget(self,ANCHO_VENTANA / 2 - 450/2,150,500,300,None,None,"Recursos/Menu/Buttons/you win.png",None,"Arial",30,C_BLACK)
        
        self.lose_game = False
        self.lose = Widget(self,ANCHO_VENTANA / 2 - 450/2,170,500,300,None,None,"Recursos/Menu/Buttons/you lose.png",None,"Arial",30,C_BLACK)
