...
class Enemy:
    def __init__(self,x,y,speed,move_rate_ms,frame_rate_ms,screen) -> None:
        self.stay_l = Auxiliar.get_img("Recursos/Enemies/AngryPig/Idle (36x30).png",9,1,False,1,2)
        self.stay_r = Auxiliar.get_img("Recursos/Enemies/AngryPig/Idle (36x30).png",9,1,True,1,2)
        self.hit = Auxiliar.get_img("Recursos/Enemies/AngryPig/Hit 1 (36x30).png",5,1,False,1,2)
        self.frame = 0
...
class EnemyGreen(Enemy):
    def __init__(self, x, y, speed, move_rate_ms, frame_rate_ms,screen) -> None:
        ...
        self.stay_l = Auxiliar.get_img("Recursos/Enemies/AngryPig/Idle (36x30).png",9,1,False,1,2)
        self.stay_r = Auxiliar.get_img("Recursos/Enemies/AngryPig/Idle (36x30).png",9,1,True,1,2)
        self.move_l = Auxiliar.get_img("Recursos/Enemies/AngryPig/Run (36x30).png",12,1,False,1,2)
        self.move_r = Auxiliar.get_img("Recursos/Enemies/AngryPig/Run (36x30).png",12,1,True,1,2)
        self.hit = Auxiliar.get_img("Recursos/Enemies/AngryPig/Hit 1 (36x30).png",5,1,False,1,2)
...
class EnemyPlant(Enemy):
    def __init__(self, x, y, speed, move_rate_ms, frame_rate_ms,screen) -> None:
        super().__init__(x, y, speed, move_rate_ms, frame_rate_ms,screen)
        self.stay_l = Auxiliar.get_img("Recursos/Enemies/Plant/Idle (44x42).png",11,1,False,1,1.5)
        self.stay_r = Auxiliar.get_img("Recursos/Enemies/Plant/Idle (44x42).png",11,1,True,1,1.5)
        self.attack_planta_l = Auxiliar.get_img("Recursos/Enemies/Plant/Attack (44x42).png",8,1,False,1,1.5)
        self.spawn(DIRECTION_L)
...
class EnemyGhost(Enemy):
    def __init__(self, x, y, speed, move_rate_ms, frame_rate_ms, screen) -> None:
        ...
        self.stay_l = Auxiliar.get_img("Recursos/Enemies/Ghost/Desappear (44x30).png",4,1,False,1,1.5)
        self.stay_r = Auxiliar.get_img("Recursos/Enemies/Ghost/Desappear (44x30).png",4,1,True,1,1.5)
        self.spawn(DIRECTION_R)
        self.hit = Auxiliar.get_img("Recursos/Enemies/Ghost/Hit (44x30).png",5,1,True,1,1.5)
        self.attack_ghost = Auxiliar.get_img("Recursos/Enemies/Ghost/Idle (44x30).png",10,1,True,1,1.5)
...
class EnemyRino(Enemy):
    def __init__(self, x, y, speed, move_rate_ms, frame_rate_ms, screen) -> None:
        ...
        self.stay_l = Auxiliar.get_img("Recursos/Enemies/Rino/Idle (52x34).png",11,1,False,1,1.5)
        self.stay_r = Auxiliar.get_img("Recursos/Enemies/Rino/Idle (52x34).png",11,1,True,1,1.5)  
        self.spawn(DIRECTION_L)
        self.move_l = Auxiliar.get_img("Recursos/Enemies/Rino/Run (52x34).png",6,1,False,1,1.5)
        self.move_r = Auxiliar.get_img("Recursos/Enemies/Rino/Run (52x34).png",6,1,True,1,1.5)
        
        self.hit = Auxiliar.get_img("Recursos/Enemies/Rino/Hit (52x34).png",5,1,False,1,1.5)
