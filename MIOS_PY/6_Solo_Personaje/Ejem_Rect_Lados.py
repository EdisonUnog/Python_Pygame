...
img = pygame.image.load("Recursos/Personaje/Salta/0.png")
...
img2 = pygame.image.load("Recursos/Personaje/Salta/0.png")
...
img3 = pygame.image.load("Recursos/Personaje/Salta/0.png")
